...
class CreateAvatarVC: BaseVC,UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        user = Utilities.share.getcurrUser()
        login(statusSV: "Loading ...", identityCard: identityCard, password: password)
    ...
    func login(statusSV: String, identityCard: String, password: String){
        //gửi yêu cầu login lên sv, nhận về
        SVProgressHUD.show(withStatus: statusSV)
        SVProgressHUD.setDefaultMaskType(.clear)
        let params: [String:Any] = ["identityCard":identityCard,
                                    "password": password]
...
extension CreateAvatarVC: BaseButtonDelegate{
    ...
    func upload(images: [UIImage]) {
        ...
        SVProgressHUD.setDefaultMaskType(.clear)
        guard let data0 = images[0].jpegData(compressionQuality: 0.5),
            let data1 = images[1].jpegData(compressionQuality: 0.5),
            let data2 = images[2].jpegData(compressionQuality: 0.5),
            let data3 = images[3].jpegData(compressionQuality: 0.5),
            let data4 = images[4].jpegData(compressionQuality: 0.5),
            let data5 = images[5].jpegData(compressionQuality: 0.5) else {
            return
        }
        ...
        let userid = user?._id ?? ""
        multipartFormData.append(data0, withName: "avatars", fileName: "\(userid)_img0.jpg", mimeType: "image/png")
        multipartFormData.append(data1, withName: "avatars", fileName: "\(userid)_img1.jpg", mimeType: "image/png")
        multipartFormData.append(data2, withName: "avatars", fileName: "\(userid)_img2.jpg", mimeType: "image/png")
        multipartFormData.append(data3, withName: "avatars", fileName: "\(userid)_img3.jpg", mimeType: "image/png")
        multipartFormData.append(data4, withName: "avatars", fileName: "\(userid)_img4.jpg", mimeType: "image/png")
        multipartFormData.append(data5, withName: "avatars", fileName: "\(userid)_img5.jpg", mimeType: "image/png")
